...
# gensim is imported lazily inside Word2VecTransformer to avoid import errors
# on environments where gensim is not installed (e.g. Streamlit Cloud)
...
class Word2VecTransformer(BaseEstimator, TransformerMixin):
    ...
    def fit(self, X, y=None):
        # Lazy import so gensim is only required when this class is actually used
